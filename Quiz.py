...
q4 = Question('en kolay programlama dili hangisidir?', ['C#','Python','Java','Javascript'],'Python')
q5 = Question('en sevilen programlama dili hangisidir?', ['C#','Python','Java','Javascript'],'Python')
